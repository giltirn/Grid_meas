...
namespace GridMeas{
  ...
  void splitGridMixedPrecInvertGen(std::vector<LatticeSCFmatrixD> &msol, std::vector<LatticeSCFmatrixD> &msol_midprop,
    ...
    LinearFunction<FermionFieldD>* mcg = MixedCGfactory(args, subgrid_action_f.FermionRedBlackGrid(),  hermop_f, hermop_d);
  ...
  void splitGridMixedPrecInvert(std::vector<LatticeSCFmatrixD> &msol,
				...
				FermionActionD &subgrid_action_d, FermionActionF &subgrid_action_f,
				const MixedCGargs &args){
    splitGridMixedPrecInvert(msol, msrc, action_d, subgrid_action_d, subgrid_action_f, args, (std::vector<Real> const*)nullptr, (std::vector<FermionFieldD> const *)nullptr);
  }
  ...
  void splitGridMixedPrecInvertWithMidProp(std::vector<LatticeSCFmatrixD> &msol, std::vector<LatticeSCFmatrixD> &msol_mid,
					   ...
					   FermionActionD &subgrid_action_d, FermionActionF &subgrid_action_f,
					   const MixedCGargs &args){
    splitGridMixedPrecInvertWithMidProp(msol,msol_mid,msrc,action_d,subgrid_action_d,subgrid_action_f,args,(std::vector<Real> const*)nullptr, (std::vector<FermionFieldD> const *)nullptr);
  }
